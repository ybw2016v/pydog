...
stopwords = {}
isCN = 1 #默认启用中文分词
text_path = 'ccp.txt' #设置要分析的文本路径
font_path = '/usr/share/fonts/windows-fonts/STKAITI.TTF' # 为matplotlib设置中文字体路径没

stopwords_path = 'stop0.txt' # 停用词词表
# imgname1 = "WordCloudDefautColors.png" # 保存的图片名字1(只按照背景图片形状)
# imgname2 = "WordCloudColorsByImg.png"# 保存的图片名字2(颜色按照背景图片颜色布局生成)
my_words_list = ['中国特色社会主义','中华民族伟大复兴'] # 在结巴的词库中添加新词
#
